...
<div ng-app="slotBookingApp">
	...
	<!-- top header  -->
		<div class="header" > <!-- ng-controller="empViewCont"-->
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li class="dropdown">
							<a href="?p=slotBook" class="dropdown-toggle">
						...
						<li class="dropdown">
							<a href="?p=slotBookedHistory" class="dropdown-toggle">
								<span class="micon"><i class="fa-solid fa-table-list" style="color: #ffffff; font-size:16px;"></i></span><span class="mtext">Booking History</span>
							</a>
							<!-- <ul class="submenu">
	...
	<!-- main body  -->
		<div class="main-container">
			<?php
				...
				// else 
                if($page == 'slotBook'){
					require_once('slotBook.php');
				}
				else if($page == 'slotBookedHistory'){
					require_once('slotBookedHistory.php');
				}
